...
public class TumakuBLE {
    ...
    public static final String SENSORTAG_KEY_SERVICE = "0000ffe0-0000-1000-8000-00805f9b34fb"; //Service for serial connection and full HM-10 control
    public static final String SENSORTAG_KEY_DATA = "0000ffe1-0000-1000-8000-00805f9b34fb"; //Characteristic for serial connection
	...
	protected TumakuBLE(Context context){
		mContext= context;
		mDeviceAddress= null;
